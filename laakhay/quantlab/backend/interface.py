...
from ..types import Shape, Axis, Array
...
class Backend(object):
    ...
    def full(self, shape: Shape, value: float, dtype: any = None, device: Device | None = None) -> Array: ...
    def arange(self, *args, dtype: any = None, device: Device | None = None) -> Array: ...
    def linspace(self, start: float, stop: float, num: int = 50, device: Device | None = None) -> Array: ...
    def eye(self, n: int, m: int | None = None, device: Device | None = None) -> Array: ...
    
    def random_key(self, seed: int) -> any: ...
    def random_normal(self, key: any, shape: Shape, dtype: any = None, device: Device | None = None) -> Array: ...
    def random_uniform(self, key: any, shape: Shape, low: float = 0.0, high: float = 1.0, 
                      dtype: any = None, device: Device | None = None) -> Array: ...
